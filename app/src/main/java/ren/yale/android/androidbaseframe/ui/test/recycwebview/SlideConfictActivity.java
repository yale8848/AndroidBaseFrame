 ...
 */
@Route(path = Navigate.PATH.RecyclerWebviewEvent)
public class SlideConfictActivity extends AppCompatActivity {
    ...
    private static final int ITEM_VIEW_COUNT = 20;
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if(webViewHolder == null) {
                webViewHolder = new WebViewHolder(inflater.inflate(R.layout.test_item_webview, parent, false));
            }
            return webViewHolder;
        }
